...
// TODO: Non standard flag defined by us to mark the descriptor that contains
// the extents of the buffer to be used for communication with the normal world
...
typedef struct {
  ...
  EFI_SMRAM_DESCRIPTOR  Descriptor[5];
} EFI_SMRAM_HOB_DESCRIPTOR_BLOCK;
